 ...
 * @author BRANDY
 */
public class SDashboard1 extends javax.swing.JFrame {
                    ...
                    .addGroup(jp2Layout.createSequentialGroup()
                        ...
                        .addGroup(jp2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jp2Layout.createSequentialGroup()
                                .addGap(171, 171, 171)
                                .addGroup(jp2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(LAdmNo, javax.swing.GroupLayout.PREFERRED_SIZE, 262, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        UnitRegistration unit=new UnitRegistration();
                ...
                unit.LadmNo.setText(LAdmNo.getText());
...
try {
 ...
 SDashboard1 sboard=new SDashboard1();
   ...
   String sql="SELECT `Units`,`Semester` FROM `units_registered` WHERE `AdmNo` = '"+ AdmNo +"'";
   ResultSet rs = stm.executeQuery(sql);
   ...
   //jUnits.getColumnModel().getColumn(3).setCellRenderer(new TableActionCellRender());
    ...
    ViewUnits ed=new ViewUnits();
    ed.setVisible(true);
   
    DefaultTableModel model=(DefaultTableModel)ed.jUnits.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SDashboard1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
